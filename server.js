...
app.use("/api/v1/campaigns", require("./routes/campaignRoutes.js"));
app.use("/api/v1/volunteers", require("./routes/volunteerRoutes.js"));
...
app.listen(PORT, () =>
  console.log(
    `Server running in ${process.env.DEV_MODE} on ${process.env.PORT}`.bgBlue
      .white
  )
);
